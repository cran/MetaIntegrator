...
date: "`r Sys.Date()`"
author: "Winston A. Haynes, Francesco Vallania, Aurelie Tomczak, Timothy E. Sweeney, Erika Bongen, Purvesh Khatri"
output:
...
### 3. Validatation on independent validation cohorts
...
**Imports:** [rmeta](http://cran.r-project.org/package=rmeta), `r Biocpkg("multtest")`, [ggplot2](http://cran.r-project.org/package=ggplot2), parallel, [bear](http://cran.r-project.org/package=bear)

**Suggests:** `r Biocpkg("BiocStyle")`, [knitr](http://cran.r-project.org/package=knitr), [rmarkdown](http://cran.r-project.org/package=rmarkdown), [RUnit](http://cran.r-project.org/package=RUnit), `r Biocpkg("BiocGenerics")`
